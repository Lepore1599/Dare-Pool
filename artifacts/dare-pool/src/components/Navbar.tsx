...
import { Flame, Trophy, Plus, User, LogOut } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link href="/create">
            <Button
              size="sm"
              className="ml-1 gap-1.5 bg-primary hover:bg-primary/90 text-white glow-primary-sm"
              data-testid="nav-create-dare"
            >
